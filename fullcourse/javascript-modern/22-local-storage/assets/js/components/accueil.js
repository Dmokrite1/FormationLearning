    ...
    this.innerHTML = `
       <main class="max-w-7xl mt-8 mx-auto bg-yellow-200">
        ...
        <form class="bg-purple-300 shadow-lg rounded p-8 grid grid-cols-3 gap-8">
          ...
          <div class="flex flex-col">
            <label for="author" class="text-sm font-bold mb-1">Auteur</label>
            <input type="text" id="author" name="author" class="border-2 rounded px-3 py-1">
          </div>
          <div class="flex flex-col">
          ...
          <div class="flex flex-col col-span-3">
            <label for="comment" class="text-sm font-bold mb-1">Commentaire</label>
            <textarea id="comment" name="comment" class="border-2 rounded px-3 py-1"></textarea>
          </div>
